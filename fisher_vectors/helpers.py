...
def train(fisher_vectors, X, Y, G, svm_c=None, cv_results_path=None):
...
def cross_test(X,
    ...
    for f, (train_idxs, test_idxs) in enumerate(cv_split):
        ...
        train_results, train_scores, fold_cv_results = train(fvs,
                                            X_train,
                                            Y_train,
                                            G_train,
                                            svm_c=svm_c)
        ...
        test_results, test_scores = test(fvs, X_test, Y_test)
